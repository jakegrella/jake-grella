...
export const Code = () => (
  <div className="content">
    ...
    <section>
      <h2>About</h2>
      <p>
        I'm a full stack web engineer with a desire to make a difference through
        my work. I care deeply about how humans interact with products and I
        take pride in my PRs.
      </p>
    </section>
    <section>
      <h2>Experience</h2>
      <ul>
        ...
        <li>
          ...
          <p className="gray">
            Built frontend components used to onboard patients at clinics and
    ...
    <section>
      ...
      <ul>
        <li>
          ...
          <p className="gray">
            Photography niche photo sharing app where the photos take priority
            (WIP)
          </p>
        </li>
        <li>
          <p>
            ...
            <a href="https://headedwesttt.com" target="_blank" rel="noreferrer">
              live
            </a>
            <span className="gray">, </span>
            <a
